...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\myuline{'Power', a hardware-accelerated game engine}}}{Nov 2020 -- Present}
      {Solo project}{Boone, North Carolina}
      \resumeItemListStart
        \resumeItem{Featured open-source game engine project}
    ...
    \resumeSubheading
      {\href{https://spencer.imbleau.com/research/native_game_engine_2018.pdf}
